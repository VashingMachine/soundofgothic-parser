...
instance SVM_4 (C_SVM)
{
	...
	// -----------------------------------------------------------------------------------------------------------------------
	Smalltalk01					= "SVM_4_Smalltalk01"				;//...to rzeczywiœcie prawd...
...
instance SVM_6 (C_SVM)
{
	...
	UNTERSTADT_2_TEMPEL			= "SVM_6_UNTERSTADT_2_TEMPEL"		;//IdŸ od strony kuŸni przez przejœcie, a dojdziesz do placu œwi¹tynnego.
	UNTERSTADT_2_HAFEN			= "SVM_6_UNTERSTADT_2_HAFEN"		;//IdŸ od strony kuŸni w dó³ ulic¹ portow¹, a dojdziesz do portu.
	TEMPEL_2_UNTERSTADT			= "SVM_6_TEMPEL_2_UNTERSTADT"		;//Od placu œwi¹tynnego odchodzi przejœcie prowadz¹ce do dolnej czêœci miasta.
	TEMPEL_2_MARKT				= "SVM_6_TEMPEL_2_MARKT"			;//Kiedy bêdziesz przed œwi¹tyni¹, skrêæ w lewo i idŸ wzd³u¿ murów miejskich, a dojdziesz do targowiska.
	...
	MARKT_2_TEMPEL				= "SVM_6_MARKT_2_TEMPEL"			;//Je¿eli pójdziesz wzd³u¿ murów miejskich od strony targowiska, to dojdziesz do œwi¹tyni.
	MARKT_2_KASERNE				= "SVM_6_MARKT_2_KASERNE"			;//Koszary to ten wielki budynek. Dostaniesz siê do nich po schodach naprzeciwko gospody.
	MARKT_2_GALGEN				= "SVM_6_MARKT_2_GALGEN"			;//Po prostu przejdŸ obok koszar, a dojdziesz do placu wisielców.
	GALGEN_2_TEMPEL				= "SVM_6_GALGEN_2_TEMPEL"			;//IdŸ od strony placu wisielców w dó³ uliczk¹, a dojdziesz do placu œwi¹tynnego.
	GALGEN_2_MARKT				= "SVM_6_GALGEN_2_MARKT"			;//Po prostu przejdŸ obok koszar, a dojdziesz do targowiska.
	GALGEN_2_KASERNE			= "SVM_6_GALGEN_2_KASERNE"			;//Koszary to ten wielki budynek. Dostaniesz siê do niego po schodach.
	KASERNE_2_MARKT				= "SVM_6_KASERNE_2_MARKT"			;//Po prostu zejdŸ po schodach na lewo od g³ównego wejœcia, a dojdziesz do targowiska.
	KASERNE_2_GALGEN			= "SVM_6_KASERNE_2_GALGEN"			;//Po prostu zejdŸ po schodach na prawo od g³ównego wejœcia, a dojdziesz do placu wisielców.
	HAFEN_2_UNTERSTADT			= "SVM_6_HAFEN_2_UNTERSTADT"		;//IdŸ od strony muru przy nabrze¿u w górê ulic¹ portow¹, a dojdziesz do dolnej czêœci miasta.
	// -------------------------------------------------------------------------------------
	...
	ADDON_WRONGARMOR			= "SVM_6_Addon_WrongArmor";				//To nie jest twoje ubranie. Nie bêdê z tob¹ rozmawiaæ.
	ADDON_WRONGARMOR_SLD		= "SVM_6_ADDON_WRONGARMOR_SLD";			//Jak ty wygl¹dasz? Ubierz siê porz¹dnie!
	ADDON_WRONGARMOR_MIL		= "SVM_6_ADDON_WRONGARMOR_MIL";			//Jesteœ ¿o³nierzem! Ubierz siê odpowiednio!
	ADDON_WRONGARMOR_KDF		= "SVM_6_ADDON_WRONGARMOR_KDF";			//Twoje ubranie nie przynosi naszemu zakonowi chluby. Przebierz siê!
	ADDON_NOARMOR_BDT			= "SVM_6_ADDON_ADDON_NOARMOR_BDT";		//Nie masz nawet pancerza. Zabieraj siê st¹d!

	ADDON_DIEBANDIT				= "SVM_6_ADDON_DIEBANDIT";				//Giñ, bandycki pomiocie!
	ADDON_DIRTYPIRATE			= "SVM_6_ADDON_DIRTYPIRATE";			//Piracka œwinia!
};
